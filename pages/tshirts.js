              ...
              return (
                <div
                  ...
                  <Link
                    ...
                    <div className="mt-1 text-center md:text-start">
                      ...
                      {/* <div className="mt-1 text-gray-600 text-sm space-x-1">
                      ...
                      <div className="mt-1 text-gray-600 text-sm space-x-1">
                        {["red", "blue", "black", "white", "pink", "green", "yellow"].map(color => (
                          products[item].color.includes(color) && (
                            <button
                              key={color}
                              className={`border-2 border-gray-300 rounded-full bg-none bg-${color}-700 hover:bg-${color}-600 w-6 h-6 focus:outline-none`}
                            ></button>
                          )
                        ))}
                      </div>
